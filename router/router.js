...
window.onload = function () {
    ...
    columns.forEach((col, index) => {
        col.style.opacity = 0; // Set initial opacity to 0 (hidden)
        ...
        }, index * 200); // Apply delay for each column
    });
    ...
    var text = "Understanding Edge Routers: What They Are and How They Work"; // Text to display
    ...
    function typeFooter() {
        if (!deleting) {
            ...
            if (footerIndex > footerText.length) {
                deleting = true; // Start deleting after typing completes
